export const rapidApiKey='1000097e46msh0b2babe9ce56a53p135490jsnf2419717f57b'

export const sliderImages=[
    require('../assets/img/slide1.png'),
    require('../assets/img/slide2.png'),
    require('../assets/img/slide3.png'),
    require('../assets/img/slide4.png'),
    require('../assets/img/slide5.png'),
]

// mage for section body
export const bodyParts=[
    {
        name:"back",
        image:require('../assets/img/back.png'),
    },
    {
        name:"cardio",
        image:require('../assets/img/cardio.png'),
    },
    {
        name:"lower arms",
        image:require('../assets/img/lower_arms.png'),
    },
    {
        name:"chest",
    ...
    {
        name:"lower legs",
        image:require('../assets/img/lower_legs.png'),
    },
    {
        name:"neck",
        image:require('../assets/img/neck.png'),
    },
    {
        name:"shoulders",
        image:require('../assets/img/shoulders.png'),
    },
    {
        name:"upper arms",
        image:require('../assets/img/upper_arms.png'),
    },
    {
        name:"upper legs",
        image:require('../assets/img/upper_legs.png'),
    },
    {
        name:"waist",
        image:require('../assets/img/waist.png'),
    },
]
